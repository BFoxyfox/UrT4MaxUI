...
- Modal-like darkened background effects (ESC menu, scoreboard, alerts)
- Readability improvements (text, alignment, spacing)
- Harmonized button and hover behavior
- Custom UI click sound (`sound/misc/kcaction.wav`)
- Build script to generate a clean `pk3` automatically

## Packaging / Distribution

The pack is generated as a `.pk3` (default: `zzz_urt4maxui_v1.pk3`) including:
